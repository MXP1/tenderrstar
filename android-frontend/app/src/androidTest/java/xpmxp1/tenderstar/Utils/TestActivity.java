package xpmxp1.tenderstar.Utils;
...
public class TestActivity extends AppCompatActivity     implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        content.setId(R.layout.activity_start);
        setContentView(content);
    }

    public void setFragment(Fragment fragment) {
        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
        fragmentTransaction.replace(R.layout.activity_start,fragment,fragment.getTag());
        fragmentTransaction.commit();
    }

    public void replaceFragment(Fragment fragment) {
        getSupportFragmentManager().beginTransaction()
                .replace(R.layout.activity_start, fragment).commit();
    }
