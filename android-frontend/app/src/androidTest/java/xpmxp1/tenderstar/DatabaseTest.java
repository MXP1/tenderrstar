...
public class DatabaseTest {
    ...
    public void productAutoIncrementTest() throws Exception {
        Product product1 = new Product("AAAA", "asdf asdf asdf",5.0, 2.0, new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis() + 12345) , 0);
        Product product2 = new Product("BBBB", "asdf asdf asdf", 5.0, 2.0, new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis() + 12345) , 1);
        Product product3 = new Product("CCCC", "asdf asdf asdf",5.0, 2.0, new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis() + 12345) , 2);
    ...
    public void insertStoreTest() throws Exception {
        ...
        Store store1 = new Store("ASDF-Store", "asdf", "ASDF", "www.asdf.at", 1, 1,
                new OpeningHours(new OpeningHours.Time(), new OpeningHours.Time(), false), "asdf", "213");
        Store store2 = new Store("ASDF-Store", "asdf", "irgendwas", "www.asdf.at", 1, 1,
                new OpeningHours(new OpeningHours.Time(), new OpeningHours.Time(), false), "asdf", "213");
    ...
    public void typeConversionTest()  throws  Exception {
        Product product = new Product("AAAA", "asdf asdf asdf",5.0, 2.0, new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis() + 12345) , 0);
    ...
    public void getAllProductsForStoreTest() throws Exception {
        Store store = new Store("ASDF-Store", "asdf", "irgendwas", "www.asdf.at", 1, 1,
                new OpeningHours(new OpeningHours.Time(), new OpeningHours.Time(), false), "asdf", "213");
